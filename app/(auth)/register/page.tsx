  ...
  return (
    <div className="relative overflow-hidden items-center justify-center min-h-screen bg-gradient-to-l from-gray-900 to-gray-500">
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex w-full max-w-6xl rounded-2xl shadow-2xl bg-slate-400 z-10  md:flex-row flex-col">
          {/* Sign In Section */}
          <div className="flex flex-col justify-center md:w-1/2 w-full p-12 bg-gray-900 h-auto md:rounded-l-2xl">
            <div className="p-12">
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 outline -outline-offset-2 outline-orange-500  text-white font-bold rounded-full  hover:bg-orange-500 "
              >
                Sign In
              </button>
            </div>
